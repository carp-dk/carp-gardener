package com.example.authenticationmodule.implementation.repository
 ...
 */
class MongoAuthorizationStateRepository(private val client: MongoClient) : IAuthorizationStateRepository {
