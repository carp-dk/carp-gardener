...
import com.example.authenticationmodule.core.collection.IDataCollectionService
...
import com.example.authenticationmodule.implementation.oauth1.OAuth1DataCollectionOperatorBuilder
import com.example.authenticationmodule.implementation.oauth1.OAuth1Operator
import com.example.authenticationmodule.implementation.oauth2.OAuth2DataCollectionOperatorBuilder
import com.example.authenticationmodule.implementation.oauth2.OAuth2Operator
...
import com.example.authenticationmodule.implementation.transformer.fitbit.FitbitCarpTransformerI
import com.example.authenticationmodule.implementation.transformer.garmin.GarminCarpTransformerI
import com.example.authenticationmodule.implementation.transformer.withings.WithingsCarpTransformerI
...
class MainVerticle : AbstractVerticle() {
  ...
  private fun setUp(router: Router, properties: PropertiesConfig) {
    ...
    router.post("/wearables/api/collection/:dataSourceId").handler(BodyHandler.create()).handler { ctx: RoutingContext ->
      ...
      val payload: String? = ctx.bodyAsString
