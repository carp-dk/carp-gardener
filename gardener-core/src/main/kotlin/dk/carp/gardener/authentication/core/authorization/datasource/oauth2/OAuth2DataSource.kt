...
abstract class OAuth2DataSource(
    ...
    protected fun acquireAccessToken(event: OAuth2Event.AuthorizationCodeAcquired) {
        ...
        val accessParams: OAuth2AccessParams =
            authorizationOperator.retrieveAccessParams(
                userId = state.userId,
        ...
        eventBus.publish(
            this::class,
            OAuth2Event.AccessTokenAcquired(parameters = accessParams, stateId = state.id, dataSourceId = this.getId()),
        )
    ...
    fun refreshAccessParametersForUserAndDevice(
        ...
        val expiredRefreshToken = currentParams.extractRefreshToken()
        checkNotNull(expiredRefreshToken) {
            "Refresh token is not present for $dataSourceId/$userId!"
        }
        ...
        eventBus.publish(
            this::class,
            OAuth2Event.AccessParametersRefreshed(userId = userId, dataSourceId = dataSourceId, parameters = currentParams),
        )
    ...
    override fun publishDataCollectionExecutionEvent(
        ...
        eventBus.publish(
            this::class,
            DataCollectionExecutionEvent.OAuth2ExecutionEvent(
     ...
     */
    override fun getEstablishedAuthorizationRequestParams(): AuthorizationRequestParams = OAuth2AuthorizationRequestParams()
     ...
     */
    protected open fun getEstablishedTokenRefreshParams(): OAuth2TokenRefreshParams = OAuth2TokenRefreshParams()
