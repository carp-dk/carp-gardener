...
import dk.carp.gardener.authentication.core.authorization.devices.garmin.GarminDataCollectionType
...
class GarminTest : OAuth1Test() {
    ...
    fun dataCollectionExecutionEventIsSent() {
        ...
        val argumentCaptor = org.mockito.kotlin.argumentCaptor<IntegrationEvent>()
    ...
    fun theRightDataTransformerGetsCalled() {
        ...
        // Capture the events that were published
        val argumentCaptor = org.mockito.kotlin.argumentCaptor<ThirdPartyData>()
    ...
    fun rightTransformedDataGetsPublished() {
        ...
        val argumentCaptor = org.mockito.kotlin.argumentCaptor<TransformedData>()
