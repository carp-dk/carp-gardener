...
class FitbitCarpTransformerI : FitbitDataTypeTransformer {
    ...
    override fun transformHeartRate(data: ThirdPartyData): List<Any> = CarpDataPointBuilder.fromThirdPartyData(data)

    override fun transformBody(data: ThirdPartyData): List<Any> = CarpDataPointBuilder.fromThirdPartyData(data)

    override fun transformSleep(data: ThirdPartyData): List<Any> = CarpDataPointBuilder.fromThirdPartyData(data)

    override fun transformFood(data: ThirdPartyData): List<Any> = CarpDataPointBuilder.fromThirdPartyData(data)
}
