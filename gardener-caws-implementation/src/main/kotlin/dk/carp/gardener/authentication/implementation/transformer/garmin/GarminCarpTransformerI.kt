...
class GarminCarpTransformerI : GarminDataTypeTransformer {
    override fun transformActivity(data: ThirdPartyData): List<Any> = CarpDataPointBuilder.fromThirdPartyData(data)

    override fun transformDailySummary(data: ThirdPartyData): List<Any> = CarpDataPointBuilder.fromThirdPartyData(data)

    override fun transformSleep(data: ThirdPartyData): List<Any> = CarpDataPointBuilder.fromThirdPartyData(data)

    override fun transformStress(data: ThirdPartyData): List<Any> = CarpDataPointBuilder.fromThirdPartyData(data)

    override fun transformBodyComposition(data: ThirdPartyData): List<Any> = CarpDataPointBuilder.fromThirdPartyData(data)

    override fun transformRespiration(data: ThirdPartyData): List<Any> = CarpDataPointBuilder.fromThirdPartyData(data)
}
